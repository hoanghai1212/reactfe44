...
import DemoPropsFunctionChild from "./DemoPropsFunctionChild";
  ...
  render() {
    return (
      <div className="container mt-3">
        ...
        <div className="row justify-content-center">{this.renderProduct()}</div>
        <div className="row mt-5">
          <div className="col-4 text-center">
            <h3>VinSmart Live</h3>
            <img className="w-100" src="./img/vsphone.jpg" alt="iphone" />
          </div>
          <div className="col-8">
